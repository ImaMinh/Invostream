...
# -------
# Note: worker_process must not be async, it creates the issue: exception=TypeError('coroutines cannot be used with run_in_executor()')>
# -------
def worker_process(batch_file_paths: list[str], batch_id):
    """
