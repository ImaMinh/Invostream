...
export default function InvoiceTableBentoCard({
  ...
  return (
    <div
      className={`relative flex-1 flex flex-col w-full min-h-[420px] sm:min-h-[500px] p-[1px] transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] overflow-hidden shadow-2xl bg-[var(--bento-outer-bg)] ${
