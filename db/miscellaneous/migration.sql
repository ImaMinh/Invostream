...
-- UP:   psql -U youruser -d yourdb -f 001_create_invoices.sql
-- =============================================================
...
SELECT 'migration.sql: UP completed successfully' AS status;


-- === DOWN ===
-- To roll back, run the statements below manually or via your migration tool.
--
-- BEGIN;
